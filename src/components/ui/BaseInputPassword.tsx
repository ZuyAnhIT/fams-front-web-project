...
export default function BaseInputPassword({
  ...
  return (
    <Input.Password
      className={cn(
        "!rounded-xl !px-4 !py-3 !shadow-none !bg-slate-50 hover:!bg-slate-100 focus:!bg-white focus-within:!bg-white !text-gray-900 !border-transparent hover:!border-transparent focus:!border-blue-500 focus-within:!border-blue-500 focus-within:!ring-4 focus-within:!ring-blue-500/15 focus:!ring-offset-0 transition-all duration-300 [&_.ant-input]:!bg-transparent [&_.ant-input]:!text-gray-900 [&_.anticon]:!text-gray-400 hover:[&_.anticon]:!text-gray-600",
        className
      )}
      {...props}
    />
