...
export default function BaseInputPassword({
  ...
  return (
    <Input.Password
      className={cn(
        "!rounded-xl !border-2 !border-slate-300 hover:!border-slate-400 !px-4 !py-3 !shadow-none !bg-slate-50 hover:!bg-slate-100 focus:!bg-white focus-within:!bg-white !text-gray-900 focus:!border-blue-500 focus-within:!border-blue-500 focus-within:!ring-4 focus-within:!ring-blue-500/15 focus:!ring-offset-0 transition-all duration-300 [&_.ant-input]:!bg-transparent [&_.ant-input]:!text-gray-900 [&_.anticon]:!text-gray-400 hover:[&_.anticon]:!text-gray-600 [&_input:-webkit-autofill]:[transition:background-color_9999s_ease-in-out_0s] [&_input:-webkit-autofill]:[-webkit-text-fill-color:#0f172a]",
        className
      )}
      {...props}
    />
