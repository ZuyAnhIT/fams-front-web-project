...
export default function BaseInput({ className, ...props }: BaseInputProps) {
  return (
    <Input
      className={cn(
        "!rounded-xl !border-2 !border-slate-300 hover:!border-slate-400 !px-4 !py-3 !shadow-none !bg-slate-50 hover:!bg-slate-100 focus:!bg-white !text-gray-900 focus:!border-blue-500 focus:!ring-4 focus:!ring-blue-500/15 focus:!ring-offset-0 transition-all duration-300 [&:-webkit-autofill]:[transition:background-color_9999s_ease-in-out_0s] [&:-webkit-autofill]:[-webkit-text-fill-color:#0f172a]",
        className
      )}
