...
export default function WorkspacePage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full min-h-[calc(100vh-4rem)] bg-slate-50 p-6 gap-6">

      {/* CỘT TRÁI: SƠ ĐỒ TỔ CHỨC */}
      <div className="w-full lg:w-1/3 lg:min-w-[320px] lg:max-w-[400px] bg-white rounded-2xl shadow-sm border border-slate-100 p-5 flex flex-col h-[calc(100vh-7rem)]">
        <div className="flex justify-between items-center mb-5">
          ...
          {hasPermission("workspaces:create") && (
            <Button
              ...
              className="bg-brand-600 hover:bg-brand-700 font-semibold shadow-sm"
            >
              Thêm mới
            </Button>
          )}
        ...
        <div className="flex gap-2 mb-4">
          <Input
            ...
            className="flex-1 rounded-lg border-slate-200 hover:border-brand-400 focus:border-brand-500"
            allowClear
          />
          <Select
            size="middle"
      ...
      <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col h-[calc(100vh-7rem)] overflow-auto custom-scrollbar">
            ...
            <div className="flex items-start justify-between border-b border-slate-100 pb-5 mb-5">
              ...
              {hasPermission("workspaces:update") && (
                <Button
                  ...
                  className="font-medium text-slate-600 hover:text-brand-600 border-slate-200"
                >
                  Chỉnh sửa
                </Button>
              )}
