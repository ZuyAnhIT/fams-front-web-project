...
import { Table, Tag, DatePicker, Select } from "antd";
...
export default function AttendanceSummaryTab() {
  ...
  const columns: ColumnsType<AttendanceSummaryResponse> = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          {record.late && <Tag color="warning">Muộn {record.lateMinutes}p</Tag>}
          {record.earlyLeave && <Tag color="warning">Sớm {record.earlyLeaveMinutes}p</Tag>}
