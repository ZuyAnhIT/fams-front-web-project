...
export default function ShiftsPage() {
  return (
    <RoleGuard allowedRoles={[SystemRole.TENANT_ADMIN, SystemRole.HR_MANAGER, SystemRole.PLATFORM_ADMIN]}>
      ...
      <h1 className="text-xl font-bold text-white mb-2">Quản lý ca làm việc</h1>
      <p className="text-slate-400 text-sm">Trang phân chia ca kíp làm việc đang được phát triển.</p>
      </div>
    </RoleGuard>
  );
}
